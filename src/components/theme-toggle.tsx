...
export function ThemeToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`relative inline-flex h-9 w-9 flex-none items-center justify-center rounded-xl border border-line-strong text-muted transition hover:bg-elev hover:text-ink ${className}`}
    >
